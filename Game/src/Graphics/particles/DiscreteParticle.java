...
public abstract class DiscreteParticle extends Particle<GhostParticleSystem> {
	...
	public DiscreteParticle(GhostParticleSystem master, int stride, int life, Shape particleShape,
